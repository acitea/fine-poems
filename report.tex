...
\author{Akeela Darryl Fattha – akeelaf.2022@scis.smu.edu.sg}
\begin{document}
\date{\today}
\maketitle
...
\textbf{Code and Artifacts:} All code, datasets, and trained adapters are available in the official GitHub repository: \url{https://github.com/acitea/fine-poems}. The repository contains all notebooks for dataset generation, training, evaluation, and inference, along with some pre-trained adapter weights and evaluation results.
